...
| Mainnet fork tests           | Implemented as strict gated round trips                                                  | `tests/mainnet-fork/roundtrip.spec.ts`; `npm run test:fork` requires `MAINNET_RPC_URL`                | Requires Anchor CLI, Solana validator tooling, deployable SBF artifacts, and a mainnet RPC URL.                                       |
